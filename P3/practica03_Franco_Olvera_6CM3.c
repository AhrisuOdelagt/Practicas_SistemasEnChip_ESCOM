...
while (1)
      {
        ...
        variable1 = PIND&0x0F;  // Se enmascaran los 4 bits menos significativos para el puerto D
        variable2 = PINC&0x0F;  // Se enmascaran los 4 bits menos significativos para el puerto C
        // Se muestran los valores en decimal
        if(variable1 < 10) { 
        ...
        // Se muestran los valores en hexadecimal
        if(variable2 < 16) { 
